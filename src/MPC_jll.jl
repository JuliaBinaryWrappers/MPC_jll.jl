...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import MPC_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("2ce0c516-f11f-5db3-98ad-e0e1048fbd70"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MPC", artifacts_toml) for e in artifacts["MPC"]]
...
if best_platform === nothing
    @debug("Unable to load MPC; unsupported platform $(triplet(platform_key_abi()))")
else
